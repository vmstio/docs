...
Data in the Dragonfly databases is mostly ephemeral but to avoid problems has a snapshot taken every 5 minutes that the Dragonfly controller can restore to in the event of a service failure.
