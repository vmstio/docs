...
- Mastodon & Sidekiq ([Crusher](https://memory-alpha.fandom.com/wiki/Beverly_Crusher)) with 1 vCPU and 2GB of memory.
- Cache ([Barclay](https://memory-alpha.fandom.com/wiki/Reginald_Barclay)) with 1 vCPU and 1GB of memory.
