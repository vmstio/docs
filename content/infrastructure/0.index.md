...
- [Mastodon](/infrastructure/mastodon) (obviously)
- [PostgreSQL](/infrastructure/persistence#postgresql)
- [Redis](/infrastructure/persistence#redis)
- [Nginx](/infrastructure#reverse-proxies) (or another reverse proxy)
...
- [Object Storage](/infrastructure/persistence#object-storage)
...
There are typically four nodes with 4 vCPU and 16 GB of memory each, but this can be scaled up or down based on demand.
