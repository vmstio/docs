...
#default
    ...
    Web
    #description
    [Official Client](https://vmst.io), [Elephant](/clients/elephant), [Tangerine](/clients/tangerine), [Elk](https://elk.vmst.io/), [Semaphore](https://semaphore.vmst.io), and [Phanpy](https://phanpy.vmst.io)
    ::
...
#default
    ...
    Firefox
    #description
    [Street Pass](https://addons.mozilla.org/en-US/firefox/addon/streetpass-for-mastodon/)
    ::
    ...
    Chrome
    #description
    [Street Pass](https://chrome.google.com/webstore/detail/streetpass-for-mastodon/fphjfedjhinpnjblomfebcjjpdpakhhn)
    ::
::
