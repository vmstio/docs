...
- Servers may have improperly configured WebFinger configurations (see `WEB_DOMAIN` in [Mastodon Documentation](https://docs.joinmastodon.org/admin/config/#web_domain))
