...
- Servers may opt-out by blocking our user agent specifically in `robots.txt`, it should also respect instructions that block any crawler
...
- Servers which report suspicious user counts (ex: active users larger than total users) are not included
